...
<body>
    ...
    <form method="post">
        Ingrese numeros separados por comas: <input type="text" name="numeros" required>
    ...
    if (isset($_POST['numeros'])) {
        ...
        $arreglo = array_map('trim', $arreglo);
        $arreglo = array_map('floatval', $arreglo);

        sort($arreglo);

        echo "<h4>Elementos del arreglo ordenado:</h4><ul>";
